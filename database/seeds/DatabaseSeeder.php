...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        App\User::create([ 'name'=> 'Paulette Arp', 'email' => 'paulette.arp@gmail.com', 'password'=>bcrypt('secret'), 'is_student'=>true, 'grade_id' => '1' ]);
