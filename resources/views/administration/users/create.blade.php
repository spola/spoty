                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('administration.users.create') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="parent_email" type="parent_email" class="form-control @error('parent_email') is-invalid @enderror" name="parent_email" value="{{ old('parent_email') }}" required autocomplete="parent_email">
